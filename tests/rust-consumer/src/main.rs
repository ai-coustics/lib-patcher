...
// External functions from the patched testlib (built with different dependency versions)
unsafe extern "C" {
...
fn main() {
    println!("Testing patched testlib from Rust (different dependency versions)");
    println!("=====================================================\n");
    ...
    if errors == 0 {
        ...
        println!("✓ Successfully linked patched library with different dependency versions");
